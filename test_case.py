...
class TestCase:
    def test_place_bid_orders(self):
        ...
        assert agent.reserved_cash == cost
        assert agent.cash == 100000 - cost
    ...
    def test_match_order(self):
        ...
        assert bid_agent.wealth == bid_agent.cash + bid_agent.holdings['TSMC'] * filled_price * 100

        assert ask_agent.cash == cash + filled_amount
        ...
        assert ask_agent.wealth == ask_agent.cash + (ask_agent.holdings['TSMC'] + ask_agent.reserved_holdings['TSMC']) * filled_price * 100
        ...
        assert tsmc.asks_volume == {10 : 0, 9.1 : 1}
        assert tsmc.asks_orders == {10 : [], 9.1 : [ask_order_id]}
