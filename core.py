...
class Core:
    ...
    def run(self, num_simulation = 100, num_of_days = 1, time_scale = 0.001, num_of_timesteps = 100000, random_seed = 9527):
        # time
    ...
    def step(self):
        ...
        if self.timestep % 10 == 0:
            print(f"At: {self.timestep}, the trading amount is: {self.market.market_stats()}")
    ...
    def get_order_record(self, order_id):
        return self.market.get_order_record(order_id)
